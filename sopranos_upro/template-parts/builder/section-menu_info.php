					...
					<div class="text">
						...
						<?php if ($button || $ghost_button): ?>
							<div class="btn-wrap d-flex flex-wrap">
								...
								<?php get_template_part('parts/button', null, ['button' => $ghost_button, 'is_popup' => $is_popup_ghost, 'class' => 'btn-border']) ?>
								...
								<?php get_template_part('parts/content', 'popup', ['is_popup' => $is_popup_ghost, 'popup_title' => $popup_title_ghost, 'popup_text' => $popup_text_ghost, 'popup_text_below_form' => $popup_text_below_form_ghost]) ?>
